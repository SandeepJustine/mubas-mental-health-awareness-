...
public class MoodActivity extends  AppCompatActivity  { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_mood_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				mood.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
	...
	private void initializeLogic() {
		...
		if (!Data.getString("a", "").equals("")) {
			listmap = new Gson().fromJson(Data.getString("a", ""), new TypeToken<ArrayList<HashMap<String, Object>>>(){}.getType());
			listview1.setAdapter(new Listview1Adapter(listmap));
			((BaseAdapter)listview1.getAdapter()).notifyDataSetChanged();
		}
	}
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout.bottomsheet, null);
			}
			
			final LinearLayout l_back = (LinearLayout) _view.findViewById(R.id.l_back);
			final LinearLayout indicator = (LinearLayout) _view.findViewById(R.id.indicator);
			...
			if (_data.get((int)_position).get("uid").toString().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
				textview1.setText(_data.get((int)_position).get("mood").toString());
