...
public class MessageActivity extends  AppCompatActivity  { 
		...
		imageview2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (!edittext1.getText().toString().equals("")) {
					message = new HashMap<>();
					message.put("id", FirebaseAuth.getInstance().getCurrentUser().getUid());
					message.put("msg", edittext1.getText().toString());
					chat1.child(chat1.push().getKey()).updateChildren(message);
					chat2.child(chat2.push().getKey()).updateChildren(message);
					message.clear();
					edittext1.setText("");
				}
		...
		_alluser_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
					user1 = _childValue.get("email").toString();
				}
				if (_childKey.equals(getIntent().getStringExtra("seconduser"))) {
					user2 = _childValue.get("email").toString();
				}
			}
	...
	private void initializeLogic() {
		//modified by Cyber Cronus
		if (Build.VERSION.SDK_INT >= 21) { Window w = this.getWindow(); w.setNavigationBarColor(Color.parseColor("#FFFFFF")); }
		linear4.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)50, 0xFFE0E0E0));
		imageview2.setColorFilter(0xFF03A9F4, PorterDuff.Mode.MULTIPLY);
		imageview3.setColorFilter(0xFF03A9F4, PorterDuff.Mode.MULTIPLY);
		...
		chat1 = _firebase.getReference(chatroom); chat2 = _firebase.getReference(chatcopy);
		chat1.addChildEventListener(_chat1_child_listener);
		chat2.addChildEventListener(_chat2_child_listener);
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout.messag, null);
			}
			...
			textview1.setText(listmap.get((int)_position).get("msg").toString());
			if (listmap.get((int)_position).get("id").toString().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
				linear1.setGravity(Gravity.RIGHT); android.graphics.drawable.GradientDrawable ab = new android.graphics.drawable.GradientDrawable(); ab.setColor(Color.parseColor("#03A9F4")); ab.setCornerRadius(20); ab.setStroke(5, Color.parseColor("#03A9F4")); linear2.setBackground(ab);
				textview1.setTextColor(0xFFFFFFFF);
			}
			else {
				linear1.setGravity(Gravity.LEFT); android.graphics.drawable.GradientDrawable ac = new android.graphics.drawable.GradientDrawable(); ac.setColor(Color.parseColor("#E0E0E0")); ac.setCornerRadius(20); ac.setStroke(5, Color.parseColor("#E0E0E0")); linear2.setBackground(ac);
				textview1.setTextColor(0xFF424242);
			}
